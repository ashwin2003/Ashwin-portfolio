...
export function Login() {
  const { user, loading, signInWithGoogle } = useChatAuth()
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-zinc-400 mb-8">
            Sign in to join rooms and start messaging.
          </p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl
                       ...
                       text-slate-700 dark:text-zinc-200 font-medium text-sm
        ...
        <p className="text-center text-xs text-slate-400 dark:text-zinc-600 mt-4 font-mono">
