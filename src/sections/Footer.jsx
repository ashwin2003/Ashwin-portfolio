          ...
          <div className="flex gap-4">
            {Object.entries(personal.social).map(([key, url]) => (
              <a
                ...
                className="text-slate-400 dark:text-zinc-600 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded"
                aria-label={key}
              >
                {SOCIAL_ICONS[key]}
              </a>
